...
// import { handleBack, handleComplete, handleAccept } from '../redux/ordersSlice';
...
//             !isAccepted ? (
//               <>
//                 <button onClick={handleAcceptOrder} className="bg-orange-500 text-white px-4 py-2 rounded-lg mr-2" style={{ border: 'none' }}>
//                   Accept
//                 </button>
//                 <button className="bg-black text-white px-4 py-2 rounded-lg" style={{ border: 'none' }}>
//                   Reject
//                 </button>
//               </>
//             ) : (
...
//           ) : (
//             <>
//               <button disabled className="bg-orange-500 text-white px-4 py-2 rounded-lg mr-2" style={{ border: 'none' }}>
//                 Completed
//               </button>
//             </>
//           )}
...
//   useEffect(() => {
//     dispatch(fetchBookingById(orderId));
//   }, [dispatch, orderId]);
...
//   const isCompleted = order.status === 'Delivered';
//   const isAccepted = order.status === 'Out for Delivery';
...
//         {/* Header Section */}
//         <div className="flex items-center mb-6">
//           <button onClick={() => dispatch(handleBack())} className="text-gray-600 hover:text-gray-800 focus:outline-none" style={{ border: 'none', background: 'transparent', padding: 0 }}>
//             <IoMdArrowBack className="text-2xl" />
//           </button>
//           <h1 className="text-2xl font-semibold text-gray-800 ml-2">Order Details</h1>
//           <span className="ml-auto px-3 py-1 text-sm bg-orange-500 text-white rounded-full">{order.status}</span>
//         </div>
...
//           <div className="p-4 border border-gray-200 rounded-lg bg-[#F8F5F3]">
//             <h2 className="text-lg font-semibold text-gray-800 mb-3">Customer Info</h2>
//             <p className="text-gray-700 mb-2"><MdPerson className="inline-block mr-2 text-xl text-gray-600" /><span className="font-medium">Name:</span> {order.name}</p>
//             <p className="text-gray-700 mb-2"><MdPhone className="inline-block mr-2 text-xl text-gray-600" /><span className="font-medium">Phone:</span> {order.contact}</p>
//           </div>

//           <div className="p-4 border border-gray-200 rounded-lg bg-[#F8F5F3]">
//             <h2 className="text-lg font-semibold text-gray-800 mb-3">Order Info</h2>
//             <p className="text-gray-700 mb-2"><MdLocationOn className="inline-block mr-2 text-xl text-gray-600" /><span className="font-medium">From:</span> {order.pickupAddress}</p>
//             <p className="text-gray-700 mb-2"><MdLocationOn className="inline-block mr-2 text-xl text-gray-600" /><span className="font-medium">To:</span> {order.deliveryAddress}</p>
//           </div>
//         </div>
...
//           <div className="p-4 border border-gray-200 rounded-lg bg-[#F8F5F3]">
//             <h2 className="text-lg font-semibold text-gray-800 mb-3">Vehicle Info</h2>
//             <p className="text-gray-700 mb-2"><AiFillCar className="inline-block mr-2 text-xl text-gray-600" /><span className="font-medium">Vehicle:</span> {order.vehicle}</p>
//             <p className="text-gray-700 mb-2"><AiFillFileText className="inline-block mr-2 text-xl text-gray-600" /><span className="font-medium">Parcel Type:</span> {order.parcelDescription}</p>
//           </div>

//           <div className="p-4 border border-gray-200 rounded-lg bg-[#F8F5F3]">
//             <h2 className="text-lg font-semibold text-gray-800 mb-3">Payment Info</h2>
//             <p className="text-gray-700 mb-2"><MdPayment className="inline-block mr-2 text-xl text-gray-600" /><span className="font-medium">Payment:</span> {order.payment}</p>
//             <p className="text-gray-700 mb-2"><MdPayment className="inline-block mr-2 text-xl text-gray-600" /><span className="font-medium">Subtotal:</span> {order.price}</p>
//           </div>
//         </div>
...
//                   Accept
//                 </button>
//                 <button onClick={handleRejectOrder} className="bg-black text-white px-4 py-2 rounded-lg" style={{ border: 'none' }}>
//                   Reject
//                 </button>
//               </>
//             ) : (
...
const OrderDetails = () => {
  ...
  useEffect(() => {
    setIsAccepted(order?.status === 'Out for Delivery');
  }, [order]);
