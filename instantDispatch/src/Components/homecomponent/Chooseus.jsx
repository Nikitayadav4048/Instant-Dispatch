...
import './chooseus.css'
 const Chooseus =() => {
  return (
    <>
      <div className="choose-us flex lg:flex-nowrap flex-wrap  justify-center">
        ...
        <div className="choose-img  mt-10 lg:mt-0 md:mt-0 ">
             <img src={chooseimg} alt="Image" className='ch-img object-cover'/>
        </div>
      </div>
    </>
  )
